...
const navItems = [
  { key: 'dashboard',   icon: 'dashboard',   label: 'Dashboard',      path: '/babysitter-dashboard' },
  { key: 'jobs',        icon: 'jobs',        label: 'Jobs',           path: '/job-request'         },
  { key: 'availability',icon: 'availability',label: 'Availability',   path: '/set-availability'    },
  { key: 'profile',     icon: 'profile',     label: 'Profile',        path: '/my-profile'          },
  { key: 'more',        icon: 'more',        label: 'More',           path: '/more'                },
];

const JobAcceptedSuccess = () => {
    ...
    >
      ...
      >
        ...
        <p style={{ fontSize: '14px', color: '#888', lineHeight: 1.6, marginBottom: '24px', maxWidth: '280px' }}>
          You have been assigned to this job. The parent will be notified.
        </p>
        ...
        >
          ...
          <p style={{ fontSize: '13px', color: '#555', lineHeight: 1.5, fontWeight: 600, margin: 0 }}>
            You can manage your upcoming jobs from the Dashboard or the Jobs tab.
          </p>
        </div>
...
export default JobAcceptedSuccess;